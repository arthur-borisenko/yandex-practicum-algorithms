...
import main.main.sprint_3_final.solution_n46_efficent_quicksort as solution
from test.utils import testUtil


class Test(unittest.TestCase):
    def _cmp(self, n1, p1, f1, n2, p2, f2):
        if p1 < p2:
            return 1
        if p1>p2:
            return -1
        ...
        return 0
    def cmp(self,a, b):
        return self._cmp(a[0], a[1], a[2], b[0], b[1], b[2])
    def test_case1(self):
...
timofey
    ...
    def test_random(self):
        ...
        for _ in range(n):
            ...
            self.assertEqual(
                value.strip().split(),
                list(map(lambda x: x[0], expected))
            )
